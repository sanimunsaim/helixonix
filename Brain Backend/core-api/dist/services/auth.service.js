 ...
 * Register a new user
 */
export async function registerUser(params, fastify) {
    // Check uniqueness
 ...
 */
export async function loginUser(params, fastify) {
 ...
 */
export async function refreshTokens(refreshToken, fastify) {
    let payload;
    try {
