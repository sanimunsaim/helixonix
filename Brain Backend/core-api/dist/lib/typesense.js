...
export const COLLECTIONS = { ASSETS: 'assets', GIGS: 'gigs', SELLERS: 'sellers' };
...
export async function upsertDocument(collection, document) {
...
export async function searchDocuments(collection, params) {
...
export async function pingTypesense() {
    try {
