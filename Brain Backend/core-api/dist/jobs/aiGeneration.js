...
import { replicate, pollPrediction, DEFAULT_MODEL_CONFIG } from '../lib/replicate.js';
...
export function startAiGenerationWorker() {
    return new Worker('ai-generation', processAiGeneration, {
