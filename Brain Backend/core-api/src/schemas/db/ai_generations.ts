...
import {
  pgTable, uuid, varchar, text, integer, bigint, timestamp, jsonb, real, pgEnum
...
export const aiGenerations = pgTable('ai_generations', {
  ...
  outputUrls: jsonb('output_urls').$type<string[]>().default([]),
  outputKeys: jsonb('output_keys').$type<string[]>().default([]),
